...
const Home = () => {
  return (
    <div id="Home" className='bg-[#0d0d30] text-white flex flex-col md:flex-row justify-between items-start h-screen mt-5 p-10 md:p-20'>
      ...
      <div className='md:w-6/12 md:pt-10 selection:bg-fuchsia-700 selection:text-fuchsia-900'>
        ...
        <button id='contact-bt' className='ml-10 mt-10 md:mt-10 text-white py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 font-semibold hover:scale-105 rounded-3xl bg-linear-to-t from-sky-500 to-indigo-500' data-aos="fade-right" data-aos-duration="2000">Contact me</button>
      ...
      <div className="relative mt-10 sm:ml-15 md:mt-0 w-48 h-48 md:w-80 md:h-80 p-1 bg-gradient-to-r from-purple-500 via-blue-400 via-blue-800 to-pink-500 animate-gradient-border rounded-full" data-aos="fade-left" data-aos-duration="2000">
